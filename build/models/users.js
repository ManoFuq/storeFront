...
var userStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO users (first_name, last_name, user_name, password_digest) VALUES($1, $2, $3, $4) RETURNING * ';
                        hash = bcrypt_1.default.hashSync(u.password, parseInt(process.env.SALT_ROUNDS));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        conn.release();
                        if (user) {
                            x = bcrypt_1.default.compareSync(password, user.password_digest);
                            if (x) {
                                return [2 /*return*/, user];
                            }
                        }
    ...
    userStore.prototype.Authorization = function (userName, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT * FROM users WHERE user_name=($1) AND id=($2)';
                        return [4 /*yield*/, conn.query(sql, [userName, id])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        return [2 /*return*/, user];
