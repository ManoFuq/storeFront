    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(401);
                res.json("Access denied ".concat(error_1));
                return [3 /*break*/, 3];
            case 3:
                ;
                return [2 /*return*/];
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                throw new Error("Could not find product  Error: ".concat(error_2));
            case 3:
                ;
                return [2 /*return*/];
        }
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                throw new Error("Invalid entry ".concat(error_3));
            case 3:
                ;
                return [2 /*return*/];
        }
...
var productRoutes = function (app) {
    ...
    app.post('/products', auth_1.auth, create);
};
