...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                throw new Error("Unable to create new user ".concat(error_1));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                res.status(401);
                res.json("Access denied, invalid token ".concat(error_2));
                return [2 /*return*/];
            case 3: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                res.status(401);
                res.send("Access denied, no user to show ".concat(error_3));
                return [2 /*return*/];
            case 3: return [2 /*return*/];
        }
    });
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                u = _a.sent();
                token = jsonwebtoken_1.default.sign(__assign({}, u), process.env.TOKEN_SECRET);
                res.send({ token: token, u: u });
                return [3 /*break*/, 3];
            case 2:
                error_4 = _a.sent();
                res.status(401);
